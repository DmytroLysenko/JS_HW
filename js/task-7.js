...
// параметра login и верни true или false в зависимости от того, попадает ли длина параметра
...
console.log(addLogin(logins, "Dimas")); // 'Логин успешно добавлен!'
console.log(addLogin(logins, "Dimas")); // 'Такой логин уже используется!'
console.log(addLogin(logins, "Dis")); // 'Ошибка! Логин должен быть от 4 до 16 символов'
