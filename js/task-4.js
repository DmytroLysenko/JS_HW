...
const count = prompt("Введите количество ремонтных дроидов:");
if (count === null) {
    console.log('Отменено пользователем!');
} else if (count*pricePerDroid > credits) {
    console.log('Недостаточно средств на счету!');
} else {
    console.log(`Вы купили ${count} дроидов, на счету осталось ${credits - count*pricePerDroid} кредитов.`)
}
